...
import aed.twualger.Tweet;
import aed.twualger.Twualger;
import aed.twualger.TwualgerC;
import aed.twualger.UserCacheB;
...
public class TwualgerCTests {
    ...
    public static void test6()
    {
        ...
        caches.sort(Comparator.comparingInt(u -> u.useCount));
        System.out.println("Total caches: " + caches.size());
        printUserCache(caches.get(0));
